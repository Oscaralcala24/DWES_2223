    ...
    function handleSubmit(e){
        ...
        if(valido == true){
            ...
            console.log(user);
            guardarCookie(nombre,apellidos,mail)
        }
    }
    ...
    function guardarCookie(nombre, apellidos, mail){
        let d = new Date ();
        let exdays = 1
        d.setTime(d.getTime() + exdays * 24 * 60 * 60 * 1000);
        let expires =  d.toUTCString ();

        document.cookie = "Usuario=" + nombre + " " + apellidos +";Expires"+ "=" +expires
        document.cookie = "mail=" + mail + ";Expires"+ "=" +expires
